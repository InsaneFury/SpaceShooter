...
public class EnemyPatrol : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        point.position = new Vector3(Random.Range(-orthographicWidth + enemySize.x, orthographicWidth - enemySize.x),
                                             Random.Range(cam.orthographicSize - enemySize.y, -maxYPatrol + enemySize.y),0f);
    }
